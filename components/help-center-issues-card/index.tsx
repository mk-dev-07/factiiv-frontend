...
const HelpCenterIssuesCard = ({ messages }: IIssuesCard) => {
		...
		<div className="origin-top p-3 relative">
			...
			<div className="space-y-3 flex flex-col">
				{messages.map((m) => {
					return (
						...
						>
							<p>{m.text}</p>
							<p className="text-xs font-bold mt-1">you - {m.sentTime}</p>
						</div>
					);
				})}
				{myResponse &&
			...
			<div className="py-3 flex space-x-3 items-center mt-6">
				<input
					...
					placeholder="write response to admin here..."
...
export default HelpCenterIssuesCard;
