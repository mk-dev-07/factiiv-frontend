...
export const ScoreVerifiedSvg = ({
	...
	return (
		<svg viewBox="0 0 400 200" className="text-onyx-light">
			...
			{reputationScore > 25 && reputationScore <= 50 && (
				<g className="animate-fade-in">
					<circle
						cx="200.058"
						cy="91.271"
			...
			{reputationScore > 50 && reputationScore <= 75 && (
				<g className="animate-fade-in">
					<circle
						cx="200.058"
						cy="91.271"
			...
			{reputationScore > 75 && reputationScore < 100 && (
				<g className="animate-fade-in">
					<path
			...
			<path
				...
				transform={`rotate(${1.8 * reputationScore} 200 200)`}
